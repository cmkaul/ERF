                         ...
                         MultiFab& mf_PSFC_lev)
{
    ...
    NC_names.push_back("HGT");       // 19
    NC_names.push_back("C1H");       // 20
    NC_names.push_back("C2H");       // 21
    NC_names.push_back("C1F");       // 22
    NC_names.push_back("C2F");       // 23
    NC_names.push_back("DNW");       // 24
    NC_names.push_back("XLAT_V");    // 25
    NC_names.push_back("XLONG_U");   // 26
    if (use_moist) {
        NC_names.push_back("QVAPOR"); // 27
        NC_names.push_back("QCLOUD"); // 28
        NC_names.push_back("QRAIN");  // 29
    }
    NC_names.push_back("IVGTYP");     // 30
    NC_names.push_back("ISLTYP");     // 31
    if (use_lsm) {
        NC_names.push_back("TSLB");   // 32
        NC_names.push_back("SMOIS");  // 33
        NC_names.push_back("SH2O");   // 34
        NC_names.push_back("LAI");    // 35
        NC_names.push_back("ZS");     // 36
        NC_names.push_back("DZS");    // 37
        NC_names.push_back("VEGFRA"); // 38
        NC_names.push_back("TMN");    // 39
        NC_names.push_back("SHDMIN"); // 40
        NC_names.push_back("SHDMAX"); // 41
